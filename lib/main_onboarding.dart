...
/// Preview entry point for the onboarding flow — boots into the splash screen
/// and runs through login → invite → OTP → details → remember → understood →
/// wizard → app, on the real backend service container.
