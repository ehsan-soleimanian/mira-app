...
class AppUpdateSheet extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet<void>(
      ...
      backgroundColor: context.rd.card,
        ...
        child: Column(
          ...
          children: [
            ...
            DecoratedBox(
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [
                    rd.navy.withValues(alpha: 0.14),
                    rd.navy.withValues(alpha: 0.04),
                  ],
                ),
              ),
              child: Padding(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: rd.navy.withValues(alpha: 0.18),
                            blurRadius: 12,
            ...
            if (_phase == _UpdatePhase.downloading) ...[
              ...
              Icon(Icons.check_circle_rounded, color: rd.success, size: 40),
