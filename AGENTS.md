...
| `rd_capture_flow` | `/captures` · `/captures/link` · `/uploads`, SSE/poll, approve, `transcribeVoice`, `/reminders` | ✅ text/link use real transient extraction + approval; links show real crawl provenance before approval; photo upload and real device-mic transcription remain supported |
